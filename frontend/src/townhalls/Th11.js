...
export const Th11 = () => {
    ...
    return (
        <Container className='my-0.5 p-3'>
            ...
            <Helmet>
                <title>TH 11 Bases | Latest CoC Clash Bases</title>
                <meta name="description" content="Get new th11 war bases, farm bases and trophy bases" />
                <meta name="keywords" content="th11 war base, best th11 war base, coc th11 bases" />
            </Helmet>
                ...
                : error ? <Message variant='danger'>{error}</Message>
                    ...
                    <Container className="my-1 p-3">
                        ...
                        <Row xs={1} md={4} className="g-4">
                            {bases.filter((base) => {
                                if (base.townhall_level === '11' && term === "") {
                                    return base
                                } else if (base.townhall_level === '11' && term === base.category_name) {
                                    return base
                                }
                            }).map(base => (
                                <Col key={base.id}>
