...
export const Th12 = () => {
    ...
    return (
        <Container className='my-0.5 p-3'>
            ...
            <Helmet>
                <title>TH 12 Bases | Latest CoC Clash Bases</title>
                <meta name="description" content="Get new th12 war bases, farm bases and trophy bases" />
                <meta name="keywords" content="th12 war base, best th12 war base, coc th12 bases" />
            </Helmet>
                ...
                : error ? <Message variant='danger'>{error}</Message>
                    ...
                    <Container className="my-1 p-3">
                        ...
                        <Row xs={1} md={4} className="g-4">
                            {bases.filter((base) => {
                                if (base.townhall_level === '12' && term === "") {
                                    return base
                                } else if (base.townhall_level === '12' && term === base.category_name) {
                                    return base
                                }
                            }).map(base => (
                                <Col key={base.id}>
