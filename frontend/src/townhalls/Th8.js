...
<Helmet>
                <title>TH 8 Bases | Latest CoC Clash Bases</title>
                <meta name="description" content="Get new th8 war bases, farm bases and trophy bases" />
                <meta name="keywords" content="th8 war base, best th8 war base, coc th8 bases" />
            </Helmet>
                ...
                : error ? <Message variant='danger'>{error}</Message>
                    ...
                    <Container className="my-1 p-3">
                        ...
                        <Row xs={1} md={4} className="g-4">
                            {bases.filter((base) => {
                                if (base.townhall_level === '8' && term === "") {
                                    return base
                                } else if (base.townhall_level === '8' && term === base.category_name) {
                                    return base
                                }
                            }).map(base => (
                                <Col key={base.id}>
