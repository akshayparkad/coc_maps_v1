...
export const Bh7 = () => {
  ...
  return (
    <Container className='my-0.5 p-3'>
      <Helmet>
        <title>BH 7 bases | Latest CoC Clash Bases</title>
        <meta name="description" content="Get new bh7 bases" />
        <meta name="keywords" content="bh7 war base, best bh7 base, coc bh7 bases" />
      </Helmet>
      {loading ? <Loader />
        : error ? <Message variant='danger'>{error}</Message>
          ...
          <Container className="my-1 p-3">
            ...
            {bases.filter(base => base.townhall_level === '7' && base.category_name === "Builder Hall" ? base : "" ).map(base => (
                                <Col key={base.id}>
