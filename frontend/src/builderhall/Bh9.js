...
export const Bh9 = () => {
  ...
  return (
    <Container className='my-0.5 p-3'>
      <Helmet>
        <title>BH 9 bases | Latest CoC Clash Bases</title>
        <meta name="description" content="Get new bh9 bases" />
        <meta name="keywords" content="bh9 war base, best bh9 base, coc bh9 bases" />
      </Helmet>
      {loading ? <Loader />
        : error ? <Message variant='danger'>{error}</Message>
          ...
          <Container className="my-1 p-3">
            ...
            {bases.filter(base => base.townhall_level === '9' && base.category_name === "Builder Hall" ? base : "" ).map(base => (
                                <Col key={base.id}>
