...
export const Bh6 = () => {
  ...
  return (
    <Container className='my-0.5 p-3'>
      ...
      <Helmet>
        <title>BH 6 bases | Latest CoC Clash Bases</title>
        <meta name="description" content="Get new bh6 bases" />
        <meta name="keywords" content="bh6 war base, best bh6 base, coc bh6 bases" />
      </Helmet>
        ...
        : error ? <Message variant='danger'>{error}</Message>
          ...
          <Container className="my-1 p-3">
            <Row xs={1} md={4} className="g-4">
              {bases.filter(base => base.townhall_level === '6' && base.category_name === "Builder Hall" ? base : "").map(base => (
                <Col key={base.id}>
